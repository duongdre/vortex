        ...
        <div className="w-full max-w-2xl">
          <div className="glass-effect-vortex p-8 rounded-3xl">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full vortex-button text-white py-4 rounded-xl font-semibold border-none cursor-pointer"
              >
                Request Quote
              </button>
              ...
              <div className="flex gap-4 justify-center pt-4">
                <button
                  type="button"
                  className="glass-effect-vortex border border-sky-400/50 text-sky-400 px-6 py-3 rounded-xl font-semibold transition-all duration-300 hover:bg-sky-400/10"
                >
                  💬 Live Chat
                </button>
                <button
                  type="button"
                  className="glass-effect-vortex border border-pink-400/50 text-pink-400 px-6 py-3 rounded-xl font-semibold transition-all duration-300 hover:bg-pink-400/10"
                >
                  📞 Call Us
                </button>
              </div>
