...
export default function HomePage() {
  return (
    <div className="relative">
      ...
      {/* Achievements Section with Swirl Background */}
      <section className="py-24 px-4 relative overflow-hidden">
        {/* TikTok Swirl Background */}
        <div className="absolute inset-0 tiktok-swirl -z-10" />
        <div className="absolute inset-0 flowing-wave opacity-20 -z-10" />
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        ...
        <div className="absolute inset-0 tiktok-bg-pattern -z-10" />
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-pink-500/10 via-transparent to-cyan-500/10 animate-flowingWave -z-10" />
        </div>
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        {/* Dynamic Swirl Background */}
        <div className="absolute inset-0 tiktok-swirl -z-10" style={{ animationDirection: "reverse" }} />
        <div className="absolute inset-0">
          <div className="absolute w-full h-full bg-gradient-to-br from-pink-500/20 via-transparent to-cyan-500/20 animate-swirl -z-10" />
        </div>
